...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'dragSearch'               : false,
		'infowindowTemplatePath'   : 'assets/templates/infowindow-description.html',
		'listTemplatePath'         : 'assets/templates/location-list-description.html',
		'listTemplateID'           : null,
	...
	$.extend(Plugin.prototype, {
		...
		listClick: function(map, infowindow, storeStart, page) {
			...
			/*$(document).on('click.' + pluginName, '.' + "bh-sl-filters1" + ' li', function () {
				var markerId = $(this).data('markerid');
				var selectedMarker = markers[markerId];
